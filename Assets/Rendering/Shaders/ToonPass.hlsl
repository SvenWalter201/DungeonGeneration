...
#include "../ShaderLibrary/CustomToonLighting.hlsl"
...
float4 frag (Varyings input) : SV_TARGET
{
    ...
    d.albedo = base.rgb;
    d.normalWS = NormalizeNormalPerPixel(normalWSApplied);
    ...
    d.highlightColor =  INPUT_PROP(_HighlightColor);
    float3 color = CustomLighting(d);
